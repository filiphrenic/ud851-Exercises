...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadScaleFromPreferences(SharedPreferences sharedPreferences) {
        String stringScale = sharedPreferences.getString(getString(R.string.pref_scale_key),
                getString(R.string.pref_scale_default_value));
        float scale;
        try {
            scale = Float.parseFloat(stringScale);
