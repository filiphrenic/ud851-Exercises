...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        SharedPreferences sPrefs = screen.getSharedPreferences();
        int count = screen.getPreferenceCount();
        for (int i = 0; i < count; i++) {
            updateSummary(sPrefs, screen.getPreference(i));
        }
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        updateSummary(sharedPreferences, findPreference(key));
    }

    private void updateSummary(SharedPreferences sharedPreferences, Preference pref) {
        if (pref instanceof ListPreference) {
            String value = sharedPreferences.getString(pref.getKey(), "");
            setPreferenceSummary((ListPreference) pref, value);
        }
    }
    ...
    // of Preference.
    private void setPreferenceSummary(ListPreference pref, String value) {
