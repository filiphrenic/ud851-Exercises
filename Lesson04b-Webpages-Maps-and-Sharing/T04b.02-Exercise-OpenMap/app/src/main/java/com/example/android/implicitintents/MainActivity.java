...
//        Toast.makeText(this, "TO DO: Open a map when this button is clicked", Toast.LENGTH_SHORT).show();
        showMap(uri);
    }
    ...
    private void showMap(Uri uri) {
        ...
        // COMPELTED (2) Create an Intent with action type, Intent.ACTION_VIEW
