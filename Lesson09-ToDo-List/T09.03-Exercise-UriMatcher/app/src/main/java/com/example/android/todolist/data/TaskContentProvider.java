...
public class TaskContentProvider extends ContentProvider {
    ...
    public static final int TASK_SINGLE = 101;
    ...
    static {
        ...
        sMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS, TASKS);
        sMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", TASK_SINGLE);
    }
