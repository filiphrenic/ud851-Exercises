...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Intent stickyIntent = registerReceiver(null, intentFilter);
            ...
            if (stickyIntent != null && stickyIntent.hasExtra(BatteryManager.EXTRA_STATUS)) {
                int status = stickyIntent.getIntExtra(
