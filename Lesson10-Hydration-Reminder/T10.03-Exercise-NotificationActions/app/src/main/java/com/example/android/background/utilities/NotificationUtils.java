...
public class NotificationUtils {
    ...
    private static final int IGNORE_ACTION_ID = 213;
    private static final int DRINK_ACTION_ID = 21321;
    ...
    private static Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pendingReminderService = PendingIntent.getService(
                context,
                IGNORE_ACTION_ID,
                reminderService,
        ...
        return new Action(R.drawable.ic_cancel_black_24px, "No, thanks", pendingReminderService);
    }
    ...
    private static Action drinkWaterAction(Context context) {
        Intent reminderService = new Intent(context, WaterReminderIntentService.class);
        reminderService.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        ...
        return new Action(R.drawable.ic_local_drink_black_24px, "I did it", pendingReminderService);
    }
