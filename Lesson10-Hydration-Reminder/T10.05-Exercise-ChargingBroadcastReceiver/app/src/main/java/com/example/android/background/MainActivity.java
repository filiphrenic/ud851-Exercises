...
public class MainActivity extends AppCompatActivity implements
    ...
    static {
        ...
        sIntentFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        sIntentFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBroadcastReceiver = new ChargingBroadcastReciever();
    ...
    private void showCharging(boolean isCharging) {
        int imageResource;
        if (isCharging) {
            imageResource = R.drawable.ic_power_pink_80px;
        } else {
            imageResource = R.drawable.ic_power_grey_80px;
        }
        mChargingImageView.setImageResource(imageResource);
    }
