...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERVAL_SECONDS = 900; // 15 minutes
    private static final int SYNC_FLEXTIME_SECONDS = 900; // 15 minutes
    private static final String REMINDER_JOB_TAG = "hydratation_reminder_job_tag";
